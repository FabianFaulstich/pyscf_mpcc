...
#       orbitals, second list is for beta orbitals
    ...
    def kernel(self, act_hole, act_particle, idx_s, idx_d, t1=None, t2=None, eris=None, mbpt2=False):
        return self.ccsd(act_hole, act_particle, idx_s, idx_d, t1, t2, eris, mbpt2)
    def ccsd(self, act_hole, act_particle, idx_s, idx_d, t1=None, t2=None, eris=None, mbpt2=False):
