...
#        Fvv_aa  = numpy.array(imds.Fvv).copy()
    ...
    def L1_residue(self, imds, t1, t2, Fov, Fvv, Foo, M0, Mov, Mov_t2 ):

       # When we construct the residue, we construct both environment type and the fragment type, in other words, we always think in terms of the full array
    ...
    def L2_residue(self, imds, t1, t2, Joo, Jvv, Jov, Fov, Fvv, Foo):
